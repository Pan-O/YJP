...
class Options_Framework_Admin {
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    <div id="optionsframework" class="postbox">
				...
				<div id="optionsframework-submit">
					...
					<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( '恢复默认', 'theme-textdomain' ); ?>" onclick="return confirm( '<?php print esc_js( __( '确定要恢复默认吗？一旦恢复所有设置就恢复默认！', 'theme-textdomain' ) ); ?>' );" />
					<div class="clear"></div>
				</div>
				</form>
			</div> <!-- / #container -->
	...
	function save_options_notice() {
		add_settings_error( 'options-framework', 'save_options', __( '设置已成功保存', 'theme-textdomain' ), 'updated fade' );
	}
